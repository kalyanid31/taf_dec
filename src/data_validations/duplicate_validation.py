...
def duplicate_check(df, key_col):
    ...
    if duplicate_count > 0:
        ...
        status = "FAIL"
        print("duplicates are found", failed_preview)
        write_output(
            "Duplicate Check",
            status,
...
# df = spark.read.csv("C:\\Users\\kalya\\PycharmProjects\\taf_dec\\input_files\\Contact_info.csv", header=True, inferSchema = True)
#
#
# print(duplicate_check(df=df,key_col= ['Identifier']))